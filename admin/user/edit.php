...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($check){
        $data["avatarImg"] = "public/img/user/" . $file_name;
    }
                                ...
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="displayName" required class="form-control" placeholder="userName" value="<?php echo $user['displayName'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>số điện thoại</label>
                                            <input type="number" name="sdt" required class="form-control" value="<?php echo $user['sdt'] ?>">
                                        </div>

                                    </div>
                                    <div class="form-group">
                                        <label>Địa Chỉ</label>
                                        <input type="text" name="addr" required class="form-control" placeholder="1234 Main St" value="<?php echo $user['addr'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <img src="<?php echo $base_url . $user['avatarImg'] ?>" width="100" height="100" alt="">
