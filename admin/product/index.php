...
<?php
    $sql = "select product.*, category.name as `categoryName` from product, category where product.categoryID = category.ID";
                                    ...
                                    <table class="table table-bordered table-striped verticle-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img width="50" height="50" src="<?php echo $base_url.$item['avatarImg1'] ?>" alt=""></td>
                                                <td><img width="50" height="50" src="<?php echo $base_url.$item['avatarImg2'] ?>" alt=""></td>
                                                <td><img width="50" height="50" src="<?php echo $base_url.$item['avatarImg3'] ?>" alt=""></td>
                                                <td><img width="50" height="50" src="<?php echo $base_url.$item['avatarImg4'] ?>" alt=""></td>
