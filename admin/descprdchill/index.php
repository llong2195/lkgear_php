...
<?php
    $sql = "select descprdchill.* , prdchill.name as `productName` from descprdchill, prdchill where descprdchill.prdChillID = prdchill.id";
    $descprdchill = $db->fetchAll($sql);
?>
<body>
    <!--*******************
        Preloader start
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><a href="./add.php">Thêm mô tả</a></h4>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped verticle-middle">
                                        ...
                                        <tbody>
                                            <?php foreach ($descprdchill as $item) : ?>
                                            <tr>
