...
<body>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="<?php echo $base_url ?>public/site/img/header--logo.png" alt="" style="width:150px;height:150px;margin-left: 50px;"></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo $base_url ?>public/site/img/product/header-product1.jpg">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="<?php echo $base_url ?>public/site/img/header--logo.png" alt="" style="width: 100x;height:100px;margin-left:30px;"></a>
                        </div>
                        <ul>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="<?php echo $base_url ?>public/site/img/payment-item.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./public/site/js/jquery-ui.min.js"></script>
    <script src="./public/site/js/jquery.slicknav.js"></script>
    <script src="./public/site/js/mixitup.min.js"></script>
